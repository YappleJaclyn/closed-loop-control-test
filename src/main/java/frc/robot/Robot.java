...
public class Robot extends TimedRobot {
  ...
  private SparkAnalogSensor encoder;
  ...
  public Robot() {
     ...
     */
    motor = new SparkMax(2, MotorType.kBrushed);
    closedLoopController = motor.getClosedLoopController();
    encoder = motor.getAnalog();
    double conversion = 360/1.65;
     ...
     */
    motorConfig.encoder
        .positionConversionFactor(conversion)
        .velocityConversionFactor(conversion/60);
    ...
    SmartDashboard.setDefaultBoolean("Control Mode | True = Position Control", true);
